function calculator() {
      ...
      function EMIVal2(loan){
          interest = loan.annualInterestrate/12/1200;
      ...
      document.getElementById("EMICapt").innerHTML='<P><b>Loan EMI: Rs. </b>' + EMIVal2(loanstruct).EMI + '<br>' + '<b> Total Payment: Rs. </b>' + EMIVal2(loanstruct).Total +'</P>';
